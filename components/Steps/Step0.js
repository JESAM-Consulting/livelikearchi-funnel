  ...
  return (
    <div
      ...
      <div className={`md:block hidden text-center font-bold mb-5`}>
        <p>
          Sie sparen <span className="text-[#67A4FF]">49.715</span> €
        </p>
      ...
      <div className="md:my-6 my-4">
        <div className="flex md:justify-start justify-center">
          <div
            ...
            className="bg-green-1 px-5 py-3 rounded-md hover:cursor-pointer text-[#fff] transition-all ease-in-out duration-150 hover:bg-opacity-90 hover:shadow-md hover:shadow-[#706f69] font-bold lg:text-base text-sm">
